...
class _CollectionListPageState extends State<CollectionListPage> {
  ...
  Future<void> _init() async {
    ...
    await _fetchCollections(reset: true);
  }

  Future<void> _fetchCollections({required bool reset}) async {
    if (reset) {
      setState(() {
        _isLoading = true;
        _error = null;
  ...
  Future<void> _loadMore() async {
    ...
    await _fetchCollections(reset: false);
  }

  Future<void> _onRefresh() => _fetchCollections(reset: true);

  void _onSearchSubmit(String value) {
    setState(() => _searchQuery = value.trim());
    _fetchCollections(reset: true);
  }
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              ...
              if (created == true) _fetchCollections(reset: true);
            },
          ),
        ],
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            FilledButton.icon(
              onPressed: () => _fetchCollections(reset: true),
