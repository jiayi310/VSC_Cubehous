...
class _LineItem {
  ...
  String get stockCode => stockCodeCtrl.text;
  ...
  double get lineTaxableAmt =>
      selectedTaxType != null ? lineTotal : 0;
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Padding(
            padding:
                const EdgeInsets.fromLTRB(14, 10, 6, 0),
            child: Row(
              children: [
                Container(
                  width: 26,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: _miniDropdown<Location?>(
                        ...
                        onChanged: (v) {
                          setState(() => item.selectedLocation = v);
                          widget.onChanged();
                        },
                      ),
                    ),
...
class _CustomerPickerSheetState extends State<_CustomerPickerSheet> {
  ...
  Future<void> _fetch({required bool reset}) async {
    if (reset) setState(() { _loading = true; _error = null; _page = 0; });
    try {
