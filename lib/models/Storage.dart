class StorageDropdownDto {
  ...
  factory StorageDropdownDto.fromJson(Map<String, dynamic> json) {
...
class Location {
  ...
  int createdUserID;
  List<StorageDropdownDto>? storageDropdownDtoList;
  ...
  factory Location.fromJson(Map<String, dynamic> json) {
    return Location(
      ...
      storageDropdownDtoList: json['storageDropdownDtoList'] != null
          ? (json['storageDropdownDtoList'] as List)
              .map((e) => StorageDropdownDto.fromJson(e))
              .toList()
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'storageDropdownDtoList':
          storageDropdownDtoList?.map((e) => e.toJson()).toList(),
    };
  }
}
